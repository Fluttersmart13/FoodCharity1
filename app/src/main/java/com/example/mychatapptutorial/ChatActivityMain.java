...
public class ChatActivityMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    PhoneAuthOptions options=PhoneAuthOptions.newBuilder(firebaseAuth)
                            ...
                            .setActivity(ChatActivityMain.this)
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                codesent=s;
                Intent intent=new Intent(ChatActivityMain.this, otpAuthentication.class);
    ...
    protected void onStart() {
        ...
        {
            Intent intent=new Intent(ChatActivityMain.this, chatActivity.class);
